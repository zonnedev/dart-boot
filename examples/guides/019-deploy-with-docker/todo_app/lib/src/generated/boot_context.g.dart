...
import 'package:todo_app/src/controllers/health_controller.dart';
...
void $configure(BeanContainer container, BootRouter router) {
  ...
  container.register<HealthController>($HealthControllerDefinition());
  ...
  router.addAllLazy(() => $HealthControllerRoutes(container.get<HealthController>()).routes);
}
