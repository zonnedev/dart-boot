...
import 'package:todo_app/src/controllers/upload_controller.dart';
...
void $configure(BeanContainer container, BootRouter router) {
  ...
  container.register<UploadController>($UploadControllerDefinition());
  ...
  router.addAllLazy(() => $UploadControllerRoutes(container.get<UploadController>()).routes);
}
