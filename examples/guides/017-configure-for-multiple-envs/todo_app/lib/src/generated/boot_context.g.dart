...
void $configure(BeanContainer container, BootRouter router) {
  ...
  if (config.get('boot.env') == 'prod') {
    container.register<SmtpEmailService>($SmtpEmailServiceDefinition());
  container.register<EmailService>($SmtpEmailServiceDefinition());
  }
  if (config.get('boot.env') != 'prod') {
    container.register<FakeEmailService>($FakeEmailServiceDefinition());
  container.register<EmailService>($FakeEmailServiceDefinition());
  }
