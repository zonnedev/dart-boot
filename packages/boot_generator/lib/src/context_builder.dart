...
// ignore_for_file: no_leading_underscores_for_library_prefixes, unnecessary_import, unused_element
...
void $functionName(BeanContainer container, RouteRegistry router, BootConfig config, List<void Function()> deferred) {
